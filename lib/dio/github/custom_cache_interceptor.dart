...
class CustomCacheInterceptor extends StatefulWidget {
  @override
  _CustomCacheInterceptorState createState() => _CustomCacheInterceptorState();
}

class _CustomCacheInterceptorState extends State<CustomCacheInterceptor> {
  main() async {
    var dio = Dio();
