...
class ResponseInterceptor extends StatefulWidget {
  @override
  _ResponseInterceptorState createState() => _ResponseInterceptorState();
}

class _ResponseInterceptorState extends State<ResponseInterceptor> {
  main() async {
